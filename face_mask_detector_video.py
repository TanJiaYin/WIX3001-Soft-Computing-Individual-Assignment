...
def detect_and_predict_mask(frame, faceNet, maskNet):
	...
	for i in range(0, detections.shape[2]):
		#extract the confidence like probability associated with the detection
...
while True:
	#take the frame from the threaded video stream and resize it to have a maximum width of 400 pixels
	frame = vs.read()
	...
	#if the 'stop' key the alphabet "a" was pressed, break from the loop
	if key == ord("a"):
		break
